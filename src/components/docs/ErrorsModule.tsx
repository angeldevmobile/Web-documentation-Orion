		...
		<div className="space-y-6 animate-fade-in">
				...
				<div className="flex items-start gap-4">
					...
					<div>
						...
						<p className="text-foreground/70 mt-2">
							Define excepciones personalizadas y un mecanismo uniforme de
							reporte.
						</p>
					</div>
				</div>
			...
			<Card className="glass-effect border-primary/20 p-6">
				...
				<p className="text-foreground/80 mb-4">
					Orion utiliza un sistema unificado de errores basado en clases, lo que
					permite:
				</p>
				<ul className="space-y-2 text-foreground/70 list-disc list-inside">
					<li>
						Identificar el tipo exacto de error ocurrido (sintaxis, ejecución,
						tipo, etc.)
					</li>
					<li>Mostrar mensajes detallados con ubicación (línea, columna)</li>
					<li>
						Capturar y manejar errores de forma consistente dentro del
						intérprete
					</li>
				</ul>
			</Card>
						...
						<Card className="glass-effect border-primary/20 p-6">
							...
							<div className="space-y-3">
								...
								<div className="bg-background/50 rounded-lg p-4 border border-destructive/30">
									<pre className="text-sm">
										<code className="font-mono text-destructive">
											[OrionError] (line 10, col 5) Runtime fault: Division by
											zero
										</code>
									</pre>
								</div>
						...
						<Card className="glass-effect border-primary/20 p-6">
							...
							<div className="space-y-3">
								...
								<div className="bg-background/50 rounded-lg p-4 border border-destructive/30">
									<pre className="text-sm">
										<code className="font-mono text-destructive">
											[OrionError] (line 8, col 22) Type mismatch: Cannot add
											string to integer
										</code>
									</pre>
								</div>
						...
						<Card className="glass-effect border-primary/20 p-6">
							...
							<div className="space-y-3">
								...
								<div className="bg-background/50 rounded-lg p-4 border border-destructive/30">
									<pre className="text-sm">
										<code className="font-mono text-destructive">
											[OrionError] (line 4, col 8) Function failure: Too many
											arguments in call to 'print'
										</code>
									</pre>
								</div>
							</div>
			...
			<Card className="glass-effect border-primary/20 p-6">
				<h3 className="text-xl font-semibold mb-4 flex items-center gap-2">
					<span className="text-primary"></span> Utilidad global:
					raise_orion_error()
				</h3>
				<p className="text-foreground/80 mb-4">
					Función de conveniencia para lanzar errores sin crear instancias
					manualmente.
				</p>
					...
					<table className="w-full border-collapse">
						...
						<tbody>
							<tr className="border-b border-primary/10">
								...
								<td className="py-2 px-3 text-sm">
									Tipo de error (syntax, runtime, type, name, function)
								</td>
							</tr>
							<tr className="border-b border-primary/10">
								<td className="py-2 px-3 font-mono text-sm text-accent">
